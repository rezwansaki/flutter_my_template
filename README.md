...
main.dart ফাইলে main মেথডটিতে বলে দিলেই হবে। যেমন: 
void main() {
  runApp(MaterialApp(
    title: 'App Name',
    home: Home(),
...
এরপর Android এর জন্য ‘\android\app\src\main\AndroidManifest.xml’ গিয়ে label পরিবর্তন করতে হবে -
```
<application
       android:label="Expense Diary"
```

এবার flutter clean করতে হবে। এবং এ্যাপ রান করা থাকলে ক্লোজ করতে হবে যদি রান করা থাকে এবং নতুন করে রান করতে হবে।
...
৮. এবার কাজ শুরু করতে হবে। (যদি '.env' ফাইলগুলো প্রয়োজন না হয় সেক্ষেত্রে সেগুলো ওপেন করে কমেন্ট আউট করে কিছু লিখে রাখবো ফাঁকা রাখবো না এবং আর সেগুলো কল করা হয়েছে main.dart ফাইল এ, সেটাও কমেন্ট আউট করে রাখতে হবে। সবশেষে env প্যাকেজটিও কমেন্ট আউট করে রাখবো। তা না হলে Error দেখাবে।) এ্যাপ ডিবাগ করবো টারমিনাল এ ‌‌'flutter run' কমান্ড দিয়ে আর 'r' প্রেস করে 'hot reload' করবো, তাহলে কাজ কিছুটা হলেও দ্রুত হবে। সমস্যা হলে 'Shift+r' প্রেস করবো 'Hot Restart' এর জন্য।
