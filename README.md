...
৩. নিজের মত করে ফাইল ও ফোল্ডার সাজানো এবং ফাইল/ফোল্ডার পারমিশান দেয়া -
নিজের মত করে ফাইল ও ফোল্ডার সাজানো:
...
৪. '.gitignore' গিয়ে ‘.env’, ‘.env.dev’ দুইটি ফাইলকে যুক্ত করে দেবো যেন GitHub এ push না হয়। (গিটহাব প্রজেক্ট এর '.gitignore' ফাইল হতে '# Manually added by me' এই অংশ থেকে শুরু করে একদম নিচ পর্যন্ত সবটুকু কপি করে আমাদের প্রজেক্ট এ বসাবো।)
